...
\begin{frame}{LOGO}
  \begin{center}
    \only<1>{\includegraphics[width=\textwidth]{../resources/illustrations/logo_screen}}
    \only<2>{\includegraphics[height=\textheight]{../resources/illustrations/logo_turtle_1}}
    \only<3>{\includegraphics[width=.8\textwidth]{../resources/illustrations/logo_turtle_2}}
    \only<4>{\includegraphics[width=\textwidth]{../resources/illustrations/logo_turtle_3}}
  \end{center}
\end{frame}
