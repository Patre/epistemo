...
\begin{frame}{Opérations portables}
\includegraphicsabsolute{../resources/illustrations/lordi}{3.5cm}{8cm}{2cm}
  ...
  \end{coolquote}
	...
	\footlineextra{\cite{lordi}}

\end{frame}

\begin{frame}{Organisations et colloques internationaux}
	\begin{tikzpicture}
	  	\node (image) {\includegraphics[width=\linewidth]{../resources/illustrations/impact_iicd}};
		\node[draw=none,below of = image, node distance=3.5cm] {
...
\color{gray}{\tiny{\textit{François Bonneau, Marie-Françoise Colombani, Christian Forestior, Nathalie Mons}}}
...
%\begin{itemize}
%\item Khan Academy (http://www.khanacademy.org)
...
\begin{tikzpicture}[overlay, remember picture]
	  	\node[anchor=north west,inner sep=0pt] (image) at ($(current page.north west)+(-0.5cm,-2.5cm)$) {\includegraphics[width=0.5\paperwidth]{../resources/illustrations/ai_class}};
		\node[draw=none,below of = image, node distance=2.2cm] {{\tiny \it \color{black!60} Udacity (\href{http://ai-class.com}{ai-class.com})}};
		
		\node[anchor=north east,inner sep=0pt] (image) at ($(current page.north east)+(-0.5cm,-1.0cm)$) {\includegraphics[width=0.45\paperwidth]{../resources/illustrations/moodle_rentree_2012}};
		\node[draw=none,below of = image, node distance=2.1cm] {{\tiny \it \color{black!60} Moodle (\href{http://moodle.com}{moodle.com})}};
		
		\node[anchor=south west,inner sep=0pt] (image) at ($(current page.south west)+(5.5cm,0.7cm)$) {\includegraphics[width=0.53\paperwidth]{../resources/illustrations/khan_academy}};
		\node[draw=none,below of = image, node distance=1.9cm] {{\tiny \it \color{black!60} Khan Academy (\href{http://www.khanacademy.org}{www.khanacademy.org})}};
	\end{tikzpicture}
\end{frame}
...
\begin{frame}
  \personality{Nicholas Negroponte}{../resources/illustrations/nicholasnegroponte}{%
   ...
   \begin{block}{Centres d'intérêts}
     \begin{itemize}
       \item Art + Math $\rightarrow$ Architecture au MIT
       \item Art + Sciences + Ordinateurs $\rightarrow$ créativité
     \end{itemize}
...
\begin{frame}
    ...
    \end{block}
  \footlineextra{\cite{wikipedia_sugata_mitra}\cite{website_hole_in_the_wall}}
\end{frame}

\begin{frame}{Hole In the Wall (HIW)}
  \includegraphicsabsolute{../resources/illustrations/hiw_1.jpg}{9cm}{0.3cm}{2cm}

  \includegraphicsabsolute{../resources/illustrations/hiw_2.jpg}{3cm}{9.45cm}{2cm}
  \includegraphicsabsolute{../resources/illustrations/hiw_3.jpg}{3cm}{9.45cm}{4.35cm}
  \includegraphicsabsolute{../resources/illustrations/hiw_4.jpg}{3cm}{9.45cm}{6.77cm}
...
\begin{frame}{Hole In the Wall (HIW)}
  \begin{center}
    \includegraphics[width=.8\textwidth]{../resources/illustrations/soles.jpg}\\
    \textit{\color{black!60}{Self Organizing Learning Environments}}
  \end{center}
  \footlineextra{\cite{ted_mitra_1}\cite{ted_mitra_2}}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}  
  \only<2>{
    \includegraphics[width=.8\textwidth]{../resources/illustrations/behaviorisme_constructivisme}
  }
  \only<3>{
    \includegraphics[width=.7\textwidth]{../resources/illustrations/behaviorisme_vs_constructivisme}
  }
 \end{center}
