...
\begin{tikzpicture}[overlay, remember picture]
		...
		\node[draw=none,below of = image, node distance=2.2cm] {{\tiny \it \color{black!30} Udacity (\href{http://ai-class.com}{ai-class.com})}};
		...
		\node[draw=none,below of = image, node distance=2.1cm] {{\tiny \it \color{black!30} Moodle (\href{http://moodle.com}{moodle.com})}};
		...
		\node[draw=none,below of = image, node distance=1.9cm] {{\tiny \it \color{black!30} Khan Academy (\href{http://www.khanacademy.org}{www.khanacademy.org})}};
	\end{tikzpicture}
\end{frame}
