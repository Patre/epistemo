...
Malgré les critiques de Socrates et de Platon, l'éducation en Europe pendant les Moyens Âges se repose sur une étude des textes écrites par le bias de \emph{lectures} en salle de cours. En effet ce format dite de \emph{cours magistral} est conçu pour faire face à la rareté de textes


, surtout à travers le format \emph{cours magistral}. 


. Ce format, 


C'est la naissance du format \emph{cours magistral}, qu'en Anglais est appelé \emph{lecture} justement parce qu'il s'agissait à l'origine d'une lecture de textes\cite{friesen-the-lecture}. En effet la rareté des livres forçait le futur savant a retranscire lui-même les textes références à partir de ces citations orales.
\cite{walsham2003}
...
Si pour Socrates et Platon la conaissance devrait rester parmi les vivants, l'abbé Jean Trithème (1462-1516) n'est pas d'accord. En 1492 il rédige l'épitre \textbf{\emph{De laude scriptorum}} (éloge des scribes)~:

\begin{coolquote}[Jean Trithème\cite{monks-vs-press}]
[Le scribe,] quand il transcrit un sujet religieux, est par l'acte même d'écrire initié en une certain mesure à la conaissance des grands mystères, et est grandement illuminé au plus profond de son âme; car les choses que nous écrivons nous imprégnons plus fermement fermement sur l'esprit\ldots quand il rumine par rapport aux Écritures il est fréquemment enflammée par eux.
\end{coolquote}

Il faut préciser que Trithème n'est pas contre l'imprimerie en soi. Cependant il ne pense pas qu'il doit remplacer l'écriture manuelle, car ce travail est formateur\cite{abbot-trithemius}. 


En effet il semble que, contrairement à l'opinion populaire, l'Église Catholique était assez content de l'arrivé de l'imprimerie, outil permettant une standardisation plus facile des écrits religieuses, donc d'éviter trop de dérives et de mutations pouvant amener à de nouveau schismes ou hérésies. 

\cite{in-praise-of-scribes}


Pendant le Moyen Âge le centre intellectuelle du monde quitte l'Europe pour le Moyen Orient

while he is writing on good subjects, is by the very act of writing introduced in a certain measure into the knowledge of the mysteries and greatly illuminated in his innermost soul; for those things which we write we more firmly impress upon the mind…While he is ruminating on the Scriptures he is frequently inflamed by them.
