...
\subsection{Les opérations \og{}ordinateurs portables\fg{}}
...
Nous pouvons notamment citer, parmi ces initiatives, le Forum mondial sur l’éducation \cite{educ_forum} et l'opération \og{}les TIC au service de l’éducation\fg{} de l’Institut international pour la communication et le développement \cite{tics}. D'autre part, des rapports sont publiés sur le sujet dans différents pays comme par exemple le rapport \og{}un regard sur la trajectoire de
l’informatique éducative au Brésil\fg{} \cite{peixoto2006regard} ou
\og{}Indicators of computer integration in education\fg{} \cite{pelgrum1993indicators} \ldots
...
Il met également en place des \gls{SOLE}s. Il s'agit d'espaces de travail composés de grands bureaux permettant de travailler à plusieurs sur un ordinateur. Un accès au \og Granny Cloud \fg{} permanent est également mis en place.
