...
C'est en faisant ce constat que Sugata Mitra à décidé de lancer le projet \gls{HIW}. Les personnes compétentes n'allant pas dans les pays et écoles les plus défavorisées, il décide de lancer son projet en 1999 à New Delhi avec sa première action\footnote{Première action d'où est tiré le nom du projet : \og Hole in the wall \fg{} $\rightarrow$ \og Trou dans le mur \fg{}} qui consistait à encastrer un ordinateur dans le mur d'un bidonville, fournissant des logiciels et un accès internet.
