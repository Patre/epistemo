...
donc que les méthodes pédagogique ne soient pas bouleversées par l'arrivée
...
Il met également en place des \gls{SOLE}. Il s'agit d'espaces de travail composés de grands bureaux permettant de travailler à plusieurs sur un ordinateur. Un accès au \og Granny Cloud \fg{} permanent est également mis en place.
