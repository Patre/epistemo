...
Cette initiative vise à mettre en place une formation national des
...
des Landes pour l'année scolaire 2008-2009. %% @clement continue
\cite{portables35}
\cite{portables60}
\cite{portables40}
...
Le constructivisme affirme que nous ne percevons pas de copies exactes
de ce que l'on perçoit. Chacun construit ses propres concepts en
fonction de ce qu'il perçoit. En accord avec cette vision, l'éducation
